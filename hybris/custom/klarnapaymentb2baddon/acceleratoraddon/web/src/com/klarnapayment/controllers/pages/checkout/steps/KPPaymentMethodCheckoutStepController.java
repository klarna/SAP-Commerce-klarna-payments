...
public class KPPaymentMethodCheckoutStepController extends PaymentMethodCheckoutStepController
{
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		if (kpPaymentDetailsForm.isUseDeliveryAddress())
		{
			...
			if (addressData == null)
			{
				...
				return Klarnapaymentb2baddonControllerConstants.Views.Pages.MultiStepCheckout.AddPaymentMethod;
			}
	...
	public String getKlarnaForm(final Model model) throws CMSItemNotFoundException
	{
		...
		return Klarnapaymentb2baddonControllerConstants.Views.Fragments.Checkout.KPPayment;
	}
	...
	final boolean useDeliveryAddress, final Model model)
	{
		...
		return Klarnapaymentb2baddonControllerConstants.Views.Fragments.Checkout.KPBillingAddressForm;
	}
