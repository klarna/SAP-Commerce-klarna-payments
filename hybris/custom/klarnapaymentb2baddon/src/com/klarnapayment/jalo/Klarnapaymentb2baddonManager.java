 ...
 */
package com.klarnapayment.jalo;
...
import com.klarnapayment.constants.Klarnapaymentb2baddonConstants;



/**
 * This is the extension manager of the Klarnapaymentb2baddon extension.
 */
public class Klarnapaymentb2baddonManager extends GeneratedKlarnapaymentb2baddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Klarnapaymentb2baddonManager.class.getName());
	 ...
	 */
	public static Klarnapaymentb2baddonManager getInstance()
	{
		return (Klarnapaymentb2baddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Klarnapaymentb2baddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Klarnapaymentb2baddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Klarnapaymentb2baddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Klarnapaymentb2baddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Klarnapaymentb2baddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
