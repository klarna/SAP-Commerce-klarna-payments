...
/**
 */
public interface KlarnapaymentaddonControllerConstants
{


	static String ADDON_PREFIX = "addon:/klarnapaymentaddon/";
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface Signin
			{
				String KlarnaSigninConsentPage = ADDON_PREFIX + "pages/klarnaSigninRegister";
			}
		}
