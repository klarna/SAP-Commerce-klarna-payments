...
/**
 * This is the extension manager of the Klarnapaymentaddon extension.
 */
public class KlarnapaymentaddonManager extends GeneratedKlarnapaymentaddonManager
{
	 ...
	 */
	public static KlarnapaymentaddonManager getInstance()
	{
		return (KlarnapaymentaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KlarnapaymentaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KlarnapaymentaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KlarnapaymentaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KlarnapaymentaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KlarnapaymentaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
