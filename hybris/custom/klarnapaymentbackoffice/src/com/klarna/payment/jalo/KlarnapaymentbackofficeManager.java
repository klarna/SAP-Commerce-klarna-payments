...
import com.klarna.payment.constants.KlarnapaymentbackofficeConstants;
 ...
 */
public class KlarnapaymentbackofficeManager extends GeneratedKlarnapaymentbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(KlarnapaymentbackofficeManager.class.getName());
	 ...
	 */
	public static KlarnapaymentbackofficeManager getInstance()
	{
		return (KlarnapaymentbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(KlarnapaymentbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KlarnapaymentbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KlarnapaymentbackofficeManager called.");
		}
	}
