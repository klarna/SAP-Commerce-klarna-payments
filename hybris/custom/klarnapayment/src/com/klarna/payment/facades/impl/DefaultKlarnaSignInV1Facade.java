 ...
 *
 */
public class DefaultKlarnaSignInV1Facade implements KlarnaSignInV1Facade
{
	...
	@Override
	public boolean validateSigninToken(final KlarnaSigninResponse klarnaSigninResponse, final String environment)
	{
		if (klarnaSigninResponse != null && klarnaSigninResponse.getUserAccountLinking() != null
				&& StringUtils.isNotBlank(klarnaSigninResponse.getUserAccountLinking().getUserAccountLinkingIdToken()))
		{
			final boolean isValidIdToken = KlarnaTokenUtils
					.validateJWTToken(klarnaSigninResponse.getUserAccountLinking().getUserAccountLinkingIdToken(), environment);
