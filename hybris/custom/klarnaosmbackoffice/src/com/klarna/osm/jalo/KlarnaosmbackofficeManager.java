...
public class KlarnaosmbackofficeManager extends GeneratedKlarnaosmbackofficeManager
{
	 ...
	 */
	public static KlarnaosmbackofficeManager getInstance()
	{
		return (KlarnaosmbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(KlarnaosmbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KlarnaosmbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KlarnaosmbackofficeManager called.");
		}
	}
