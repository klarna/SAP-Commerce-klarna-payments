...
<klarna-placement id="osm-product-strip" data-key="credit-promotion-auto-size" data-locale="${locale}-${osmCountry}" data-purchase-amount="${priceValue}" data-theme="${osmTheme}"></klarna-placement>
