...
/**
 * This is the extension manager of the Klarnaosmaddon extension.
 */
public class KlarnaosmaddonManager extends GeneratedKlarnaosmaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(KlarnaosmaddonManager.class.getName());
	 ...
	 */
	public static KlarnaosmaddonManager getInstance()
	{
		return (KlarnaosmaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				KlarnaosmaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public KlarnaosmaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of KlarnaosmaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of KlarnaosmaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of KlarnaosmaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
