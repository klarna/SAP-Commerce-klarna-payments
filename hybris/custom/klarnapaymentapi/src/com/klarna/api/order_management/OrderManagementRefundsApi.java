...
import com.klarna.api.order_management.model.OrderManagementRefund;
...
public class OrderManagementRefundsApi extends BaseApi
{
	...
	public String create(final OrderManagementRefundObject refund) throws ApiException, IOException
	{
		...
		final List<String> refundId = response.getHeader("Refund-Id");
	...
	{
		final ApiResponse response = this.get(PATH + "/" + refundId);
