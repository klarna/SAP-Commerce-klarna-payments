 ...
 * <code>
 * java -jar bootstrap/bin/ybootstrap.jar "new com.klarna.api.KlarnapaymentapiStandalone().run();"
 * </code> From eclipse, just run as Java Application. Note that you maybe need to add all other projects like
 * ext-commerce, ext-pim to the Launch configuration classpath.
 */
public class KlarnapaymentapiStandalone
{
	/**
	...
	{
		new KlarnapaymentapiStandalone().run();
	}
