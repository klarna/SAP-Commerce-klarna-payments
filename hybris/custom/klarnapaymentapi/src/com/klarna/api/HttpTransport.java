...
public interface HttpTransport
{
	 ...
	 */
	String USER_AGENT = String.format("Language/Java_%s (Vendor/%s; VM/%s) Library/%s OS/%s", getProperty("java.version"),
			getProperty("java.vendor"), getProperty("java.vm.name"), "Klarna.kco_rest_java_" + VERSION,
	 ...
	 * @throws ApiException
	 *            if API server returned non-20x HTTP CODE, Content-Type mismatched or response contains a
