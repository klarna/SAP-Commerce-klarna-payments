...
public class DefaultKlarnapaymentapiService implements KlarnapaymentapiService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultKlarnapaymentapiService.class);
